<x-app-layout>
    <div class="w-full mb-4">
        <div class="mt-2 md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Config
                </h2>
            </div>
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#" aria-current="page"
                                    class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Config</a>
                            </div>
                        </li>
                    </ol>
                </nav>
    ...
    <livewire:admin.pages.config.config-table />
    <livewire:admin.pages.config.edit-config-dialog />
</x-app-layout>
